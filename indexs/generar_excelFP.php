        ...
        if ($this->PageNo() == 1) {
            ...
            switch ($carrera) {
                ...
                case "14":
                    ...
                    break;
                case "15":
                    $subtitulo = "Instalador y administrador de redes informaticas";
                    break;
                case "65":
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($fecha_inicio && $fecha_fin && $carrera) {
        ...
        $consulta_asistencia = "SELECT DISTINCT fecha_FP
        FROM asistencia_FP a 
        ...
        WHERE fecha_FP BETWEEN '$fecha_inicio' AND '$fecha_fin' and c.idCarrera = '$carrera';";
