...
<div class="background">
  ...
  <nav class="navbar">
      ...
      <div class="nav-left">  
      <a href="../preceptor_3.php" class="home-button">Menu Principal</a>
      ...
      <div class="dropdown-content">
        <div class="submenu">
          ...
          <div class="sub-dropdown-content">
            <a href="./enfermeria_1_a.php">Primer Año</a>
          </div>
        </div>
        ...
        <div class="sub-dropdown-content">
            <a href="./robotica_1ro_a.php">Primer Año</a>
            <a href="./robotica_2do_a.php">Segundo Año</a>
          </div>
        </div>
      </div>
...
<button id="open-attendance-button" onclick="openAttendanceModal()">Tomar Asistencia Robótica 2do Año</button>
...
<th rowspan="2">Apellido</th>
    ...
    WHERE ia.carreras_idCarrera = '49' and a2.estado = '1' 
