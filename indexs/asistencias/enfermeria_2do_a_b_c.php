...
<div class="background">
  ...
  <nav class="navbar">
    <div class="nav-left">  
    <a href="../preceptor_5.php" class="home-button">Menu Principal</a>
  ...
  <a href="#" class="dropbtn"> Elegir carrera  <i class="fas fa-chevron-down"></i></a>
    ...
    <div class="submenu">
        ...
        <div class="sub-dropdown-content">
          <a href="./enfermeria_2do_a_b_c.php">Segundo Año</a>
        </div>
    </div>
  </li>
</ul>
...
<button id="open-attendance-button" onclick="openAttendanceModal()">Tomar Asistencia Enfermería 2do Año</button>
...
<th rowspan="2">Apellido</th>
    ...
    WHERE ia.carreras_idCarrera = '33' and a2.estado = '1' 
...
<th rowspan="2">Apellido</th>
    ...
    RIGHT JOIN inscripcion_asignatura ia ON a.inscripcion_asignatura_idinscripcion_asignatura = ia.idinscripcion_asignatura 
    INNER JOIN alumno a2 ON ia.alumno_legajo = a2.legajo   
    WHERE ia.carreras_idCarrera = '34' and a2.estado = '1' 
    GROUP BY a2.nombre_alumno , a2.apellido_alumno
    ORDER BY a2.apellido_alumno";
    $query = mysqli_query($conexion, $sql);
    while ($datos = mysqli_fetch_assoc($query)) {
...
<th rowspan="2">Apellido</th>
    ...
    RIGHT JOIN inscripcion_asignatura ia ON a.inscripcion_asignatura_idinscripcion_asignatura = ia.idinscripcion_asignatura 
    INNER JOIN alumno a2 ON ia.alumno_legajo = a2.legajo   
    WHERE ia.carreras_idCarrera = '35' and a2.estado = '1' 
    GROUP BY a2.nombre_alumno , a2.apellido_alumno
    ORDER BY a2.apellido_alumno";
    $query = mysqli_query($conexion, $sql);
    while ($datos = mysqli_fetch_assoc($query)) {
    ...
    <input type="hidden" id="motivo" name="motivo" value="">
        ...
        <input type="hidden" name="idcarrera" value="35">
        <input type="submit" name="Enviar" value="Confirmar" class="btn-enviar">
            </form>
        </div>
    </div>
