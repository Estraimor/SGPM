    ...
    <div class="dropdown-content">
      <div class="submenu">
        ...
        <div class="sub-dropdown-content">
          <a href="./enfermeria_1ro_b.php">Primer Año</a>
        </div>
      </div>
...
<button id="open-attendance-button" onclick="openAttendanceModal()">Tomar Asistencia Marketing 2do Año</button>
...
<th rowspan="2">Apellido</th>
    ...
    WHERE ia.carreras_idCarrera = '58' and a2.estado = '1' 
