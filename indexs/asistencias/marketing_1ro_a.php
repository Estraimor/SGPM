...
<div class="background">
  ...
  <nav class="navbar">
    <div class="nav-left">  
    <a href="../preceptor_4.php" class="home-button">Menu Principal</a>
  ...
  <a href="#" class="dropbtn"> Elegir carrera  <i class="fas fa-chevron-down"></i></a>
    ...
    <div class="submenu">
        ...
        <div class="sub-dropdown-content">
          <a href="./enfermeria_1ro_c.php">Primer Año</a>
        </div>
      </div>
      ...
      <div class="sub-dropdown-content">
          <a href="./marketing_1ro_a.php">Primer Año</a>
        </div>
      </div>
    </div>
  </li>
...
<button id="open-attendance-button" onclick="openAttendanceModal()">Tomar Asistencia Marketing 1er Año</button>
...
<th rowspan="2">Apellido</th>
    ...
    WHERE ia.carreras_idCarrera = '55' and a2.estado = '1' 
