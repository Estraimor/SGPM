...
<button class="toggle-menu-button" id="toggle-menu-button" onclick="toggleMenu()">
 ...
 <div class="nav-right">
  ...
  <div class="contenedor">
        <h1>Enfermeria 2do Año</h1>
        <div class="hilera">
            <h2>Comisión A</h2>
            <button class="boton"><a href="../../Profesor/notas/login_notas/prueba_tabla.php?materia=142&carrera=18">EDI II: Materno neonatal</a></button> 

           
        </div>
         <div class="hilera">
            <h2>Comisión B</h2>
            <button class="boton"><a href="../../Profesor/notas/login_notas/prueba_tabla.php?materia=413&carrera=19">EDI II: Materno neonatal</a></button>       
        </div>
        <div class="hilera">
            <h2>Comisión C</h2>
            <button class="boton"><a href="../../Profesor/notas/login_notas/prueba_tabla.php?materia=424&carrera=20">EDI II: Materno neonatal</a></button>
        </div>
    </div>
