...
<button class="toggle-menu-button" id="toggle-menu-button" onclick="toggleMenu()">
 ...
 <div class="nav-right">
  ...
  <div class="contenedor">
        ...
        <div class="hilera">
            <h2>Comisión A</h2>
            <button class="boton"><a href="../../Profesor/notas/login_notas/prueba_tabla.php?materia=142&carrera=18"> Anatomía y Fisiología </a></button> 
            <button class="boton"><a href="../../Profesor/notas/login_notas/prueba_tabla.php?materia=144&carrera=18"> Fisicoquímica </a></button>

           
        </div>
         <div class="hilera">
            <h2>Comisión B</h2>
            <button class="boton"><a href="../../Profesor/notas/login_notas/prueba_tabla.php?materia=413&carrera=19">Fisicoquímica</a></button>       
        </div>
        <div class="hilera">
            <h2>Comisión C</h2>
            <button class="boton"><a href="../../Profesor/notas/login_notas/prueba_tabla.php?materia=424&carrera=20">Fisicoquímica</a></button>
        </div>
    </div>
