...
<button id="open-attendance-button" onclick="openAttendanceModal()">Tomar Asistencia Redes</button>
...
WHERE af.carreras_idCarrera = '15' OR af.carreras_idCarrera1 = '15' OR af.carreras_idCarrera2 = '15' or af.carreras_idCarrera3 = '15' AND af.estado = '1'
