...
<button id="open-attendance-button" onclick="openAttendanceModal()">Tomar Asistencia Programación WEB</button>
...
WHERE af.carreras_idCarrera = '8' OR af.carreras_idCarrera1 = '8' OR af.carreras_idCarrera2 = '8' or af.carreras_idCarrera3 = '8' AND af.estado = '1'
