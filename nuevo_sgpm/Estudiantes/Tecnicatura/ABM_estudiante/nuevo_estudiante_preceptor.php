...
<h2 class="form-container__h2">Registro de Estudiante</h2>
	...
	<div class="row">
        ...
        <input type="date" class="form-container__input half" name="edad" placeholder="Fecha de nacimiento" autocomplete="off" required>
    </div>
    <?php
	...
	<div class="row">
        ...
        <input type="text" hidden name="legajo" placeholder="N° Legajo" value="<?php echo $nuevo_legajo; ?>" class="form-container__input half" readonly>
...
function mostrarAlertaLegajo(legajo) {
    alert("El número de legajo asignado es: " + legajo);
}
