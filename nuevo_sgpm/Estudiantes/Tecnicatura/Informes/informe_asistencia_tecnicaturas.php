...
<div class="contenido">
    ...
    <form action="../../../../indexs/generar_excel.php" method="post" class="form-informes">
        <div class="form-dates">
            <div class="date-field">
                <label for="fecha_inicio">Fecha de inicio:</label>
                <input type="date" id="fecha_inicio" class="input-fecha" name="fecha_inicio">
            </div>

            <div class="date-field">
                <label for="fecha_fin">Fecha de fin:</label>
                <input type="date" id="fecha_fin" class="input-fecha" name="fecha_fin">
            </div>
        </div>
