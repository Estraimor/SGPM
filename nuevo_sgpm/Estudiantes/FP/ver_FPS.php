...
$idPreceptor = $_SESSION['id'];  // Asumiendo que guardas el ID del preceptor en la sesión.
...
$queryCarreras = "SELECT p.carreras_idCarrera, c.nombre_carrera FROM preceptores p
                  ...
                  WHERE p.profesor_idProrfesor = $idPreceptor and p.carreras_idCarrera in('8','14','15','64') ";
...
<div class="contenido">
    <div class="contenedor-materias">
        <h2 class="carrera-title">Elija la FP</h2>
        
        <div class="tabla-contenedor">
            <table id="tablaFP" class="tabla-materias">
                <thead>
                    <tr>
                        <th class="materia">Nombre de la FP</th>
                    ...
                    if (isset($carreras) && is_array($carreras)) {
                        foreach ($carreras as $carrera) { ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn-seleccionar" onclick="irAsistenciaFP('<?php echo $carrera['carreras_idCarrera']; ?>')">
                        ...
                        <tr>
                            <td colspan="2">No hay FP asignadas.</td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
...
function filtrarFP() {
    ...
    input = document.getElementById("buscadorFP");
    filter = input.value.toUpperCase();
    table = document.getElementById("tablaFP");
...
function irAsistenciaFP(idCarrera) {
    window.location.href = "asistenciaFP.php?comision=" + idCarrera;
}
</script>
...
th.materia,
td.materia {
    width: 80% !important; /* Ajusta el tamaño de la columna 'Nombre de la FP' */
}

th.select,
td.select {
    width: 20% !important; /* Ajusta el tamaño de la columna 'Seleccionar' */
}
