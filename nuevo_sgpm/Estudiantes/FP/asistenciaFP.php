...
<div class="contenido">
<form action="guardar_asistenciaFP.php" method="post" onsubmit="showModalMessage()">
...
LEFT JOIN finalizo_FP fp ON af.legajo_afp = fp.alumnos_fp_legajo_afp AND fp.carreras_idCarrera = '$comisionId'  -- Excluir sólo los que finalizaron la carrera '$comisionId'
LEFT JOIN no_aprobados na ON af.legajo_afp = na.alumnos_fp_legajo_afp AND na.carreras_idCarrera = '$comisionId'  -- Excluir sólo los que están en no aprobados para la carrera '$comisionId'
WHERE (af.carreras_idCarrera = '$comisionId' 
       OR af.carreras_idCarrera1 = '$comisionId' 
       OR af.carreras_idCarrera2 = '$comisionId' 
       OR af.carreras_idCarrera3 = '$comisionId') 
  AND af.estado = '1'
  AND fp.idfinalizo_FP IS NULL  -- Excluir los que finalizaron la carrera '$comisionId'
  AND na.idno_aprobados IS NULL  -- Excluir los que están en no aprobados para la carrera '$comisionId'
GROUP BY af.legajo_afp
                ...
                ?>
                    <tr>
                        ...
                        <td class="checkbox-cell">
                            <input type="checkbox" name="presentePrimera[]" value="<?php echo $datos['legajo_afp']; ?>" class="custom-checkbox">
                        </td>
                        <td class="checkbox-cell">
                            <input type="checkbox" name="ausentePrimera[]" value="<?php echo $datos['legajo_afp']; ?>" class="custom-checkbox">
                        </td>
