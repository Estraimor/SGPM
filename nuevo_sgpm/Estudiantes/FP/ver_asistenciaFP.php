...
<div class="contenido">
	...
	<br>
    <div class="container">
        <h2 style="color: black">Seleccione una fecha para ver la asistencia</h2>
        <div class="date-container">
            <input type="hidden" name="comisionId" id="comisionId" value="<?php echo $comisionId; ?>"> <!-- Correcto para almacenar el ID de la comisión -->
            <label for="fecha" class="fecha">Selecciona una fecha:</label>
            <input type="date" id="fecha" name="fecha" onchange="showAsistencia()">
        </div>
        <!-- Asegúrate que este método exista y esté definido en tu JS -->
        <div class="table-container">
            <table class="table-comision-a">
                <thead>
                    <tr>
                        <th rowspan="2" style="width: 5px;">N°</th>
                        <th rowspan="2" style="width: 5px;">Apellido</th>
