                ...
                if (mysqli_num_rows($result_comunicados) > 0) {
                    while ($comunicado = mysqli_fetch_assoc($result_comunicados)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="POST" class="form-comunicado" style="display:inline;">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['agregar_comunicado'])) {
        ...
        if (mysqli_query($conexion, $sql_insert)) {
            echo "<script>alert('Mensaje enviado correctamente.'); window.location.href='index_comunicados_prueba.php';</script>";
            exit;
        } else {
    ...
    if (isset($_POST['editar_comunicado'])) {
        ...
        if (trim($contenido_comunicado) !== '') {
            ...
            if (mysqli_query($conexion, $sql_update)) {
                echo "<script>alert('Comunicado actualizado correctamente.'); window.location.href='index_comunicados_prueba.php';</script>";
                exit;
            } else {
    ...
    if (isset($_POST['eliminar_comunicado'])) {
        ...
        if (mysqli_query($conexion, $sql_delete)) {
            echo "<script>alert('Comunicado eliminado correctamente.'); window.location.href='index_comunicados_prueba.php';</script>";
            exit;
        } else {
