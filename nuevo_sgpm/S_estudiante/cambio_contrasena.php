...
<link rel="icon" href="../assets/img/Logo ISPM 2 transparante.png" type="image/x-icon"/>
 ...
 <link rel="stylesheet" href="./s_estudiante.css">
...
<div class="contenido">
        ...
        <form method="POST" action="guardar_cambio_contrasena.php" onsubmit="return validatePasswords()">
...
<?php }else{header('Location: index_estudiante.php');} ?>
