                    ...
                    if (isset($carreras) && is_array($carreras)) {
                        foreach ($carreras as $carrera) { ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn-seleccionar" onclick="irAsistenciaCarrera('<?php echo $carrera['carreras_idCarrera']; ?>')">
                        ...
                        <tr>
                            <td colspan="2">No hay carreras asignadas.</td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
...
function irAsistenciaCarrera(idCarrera) {
    window.location.href = "ver_asistencia.php?comision=" + idCarrera;
}
</script>
<style>
	.contenido {
