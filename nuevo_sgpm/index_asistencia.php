...
<div class="contenido">
    <div class="contenedor-materias">
        <h2 class="tituloooo">Materias Asignadas</h2>
        <input type="text" id="buscador" placeholder="Buscar materia..." onkeyup="filtrarMaterias()">
                    ...
                    if (isset($carreras) && is_array($carreras)) {
                        foreach ($carreras as $carrera) { ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn-seleccionar" onclick="irAsistencia('<?php echo $carrera['carreras_idCarrera']; ?>')">
                        ...
                        <tr>
                            <td colspan="2">No hay materias asignadas.</td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
...
function filtrarMaterias() {
    ...
    table = document.getElementById("tablaMaterias");
...
function irAsistencia(idCarrera) {
    window.location.href = "asistencia.php?comision=" + idCarrera;
}
</script>
