...
<div class="contenido">
    <h1>Gestión de Actas Volantes Estudiantes Libres</h1>
    <form method="POST" action="./config_actas_volantes/crear_acta_volante_libres.php">
...
function obtenerDetallesAlumnos(carrera, materia, llamado, tanda, anio) {
    ...
    xhr.open(
        'GET',
        `./config_actas_volantes/obtener_cantidad_alumnos_inscriptos_libres.php?idCarrera=${carrera}&idMateria=${materia}&llamado=${llamado}&tanda=${tanda}&anio=${anio}`,
        true
    );
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
