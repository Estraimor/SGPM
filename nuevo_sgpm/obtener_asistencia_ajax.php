...
try {
    // Consulta para obtener los datos de asistencia incluyendo el nombre de la materia
    $sql_asistencia = "SELECT a2.nombre_alumno, a2.apellido_alumno, a.`1_Horario`, a.`2_Horario`, a.fecha, m.Nombre as materia
            FROM asistencia a 
...
// Consulta para contar la cantidad de ausentes 2HS
    ...
    while ($datos = mysqli_fetch_assoc($query_asistencia)) {
        echo "<tr>
                ...
                <td>{$datos['materia']}</td> <!-- Nueva columna para la materia -->
    ...
    echo "<tr>  
            <td colspan='2'>Cantidad de presentes 1HS: $cantidad_presentes1HS</td>
            <td colspan='2'>Cantidad de presentes 2HS: $cantidad_presentes2HS</td>
         </tr>";
    echo "<tr>  
            <td colspan='2'>Cantidad de ausentes 1HS: $cantidad_ausentes1HS</td>
            <td colspan='2'>Cantidad de ausentes 2HS: $cantidad_ausentes2HS</td>
         </tr>";
} catch (Exception $e) {
