...
<div class="contenido">
    ...
    <div class="container">
        ...
        <div class="date-container">
            <input type="hidden" id="comisionId" value="<?php echo $comisionId; ?>"> <!-- Correcto para almacenar el ID de la comisión -->
        ...
        <div class="table-container">
            <table class="table-comision-a" id="">
                <thead>
                    <tr>
                        <th rowspan="2" style="width: 5px;">N°</th>
                        <th rowspan="2" style="width: 5px;">Apellido</th>
                        <th rowspan="2">Nombre</th>
                        <th rowspan="2">Materia</th> <!-- Nueva columna para Materia -->
...
// Asegúrate que los siguientes métodos también estén definidos si los necesitas, y que correspondan a diferentes IDs si es necesario.
