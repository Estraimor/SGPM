...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $tomos = $_POST['tomo'];
    $folios = $_POST['folio'];
    $idCarrera = $_POST['carrera']; // Capturamos idCarrera
...
$anio = $_POST['anio'] ?? '';
    ...
    echo "<script>
        ...
        window.location.href = './lista_promocionados.php?carrera=$idCarrera&materia=$idMateria&curso=$idCurso&comision=$idComision&anio=$anio';
      </script>";
    exit();
} else {
