...
<div class="contenido">
   ...
   <h2 class="form-container__h2">Registro de Profesor</h2>
	<form action="guardar_docente.php" method="post" class="form-container">
	<div class="row">
        <input type="text" class="form-container__input half" name="nombre" placeholder="Ingrese el nombre" autocomplete="off" required>
        <input type="text" class="form-container__input half" name="apellido" placeholder="Ingrese el apellido" autocomplete="off" required>
    </div>
	<div class="row">
        <input type="number" class="form-container__input half" name="dni" placeholder="Ingrese el DNI" autocomplete="off" required>
        <input type="email" class="form-container__input half" name="email" placeholder="Ingrese su Email" autocomplete="off">
    </div>
	<div class="row">
        <input type="text" class="form-container__input half" name="celular" placeholder="Ingrese el celular" autocomplete="off">
        <input type="text" class="form-container__input half" name="Titulo" placeholder="Ingrese su Titulo" autocomplete="off">
    </div>
	<div class="row">
        <input type="text" class="form-container__input half" name="Direccion" placeholder="Ingrese su direccion residencia" autocomplete="off" required>
    </div>
    <div class="row">
        <input type="text" class="form-container__input half" name="usuario" placeholder="Ingrese su Usuario" autocomplete="off" required>
        <input type="text" class="form-container__input half" name="pass" placeholder="Ingrese su Contraseña" autocomplete="off" required>
    </div>
    <div class="row">
        <select name="rol" class="form-container__input full"> 
        <option hidden>Selecciona un rol</option>
        
          <option value="2">Acceso Sistema completo</option>
          <option value="1">Acceso area Administrativa (ABM estudiante, lista )</option>
          <option value="3">Acceso area preceptor</option>
          <option value="4">Acceso area profesor</option>
