        ...
        <tbody>
            ...
            while ($datos = mysqli_fetch_assoc($query1)) {
                ...
                <tr>
                    ...
                    <td><?php echo $datos['apellido_profe']; ?></td>
                    <td><?php echo $datos['nombre_profe']; ?></td>
                    <td><?php echo $datos['dni_profe']; ?></td>
                    <td><?php echo $datos['celular']; ?></td>
                
                    <td><?php echo $datos['Titulo']; ?></td>
             
                    <td><a href="modificar_profesor.php?idprofe=<?php echo $datos['idProrfesor']; ?>" class="modificar-button"><i class="fas fa-pencil-alt"></i></a>
                        <a href="#" onclick="return confirmarBorrado('<?php echo $datos['idProrfesor']; ?>')" class="borrar-button"><i class="fas fa-trash-alt"></i></a>
                        <a href="info_profe.php?idprofe=<?php echo $datos['idProrfesor']; ?>"" class="accion-button"><i class="fas fa-exclamation"></i></a></td>
