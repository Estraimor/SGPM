...
<div class="contenido">
    <button id="btnCargarTema" class="btn-rojo">Cargar Tema</button>
    <table id="tablaLibros" border="1" class="tabla-elegante">
        <thead>
            <tr>
                <th>Fecha</th>
                <th>Carrera</th>
...
<!-- Modal para Cargar Tema -->
<div id="modalCargarTema" class="modal">
    <div class="modal-content">
        ...
        <form id="nuevoLibroForm" action="guardar_libro_tema.php" method="post">
            ...
            <div class="modal-buttons">
                ...
                <button type="button" class="btn-blanco" id="btnCancelar">Cancelar</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        // Abrir el modal al hacer clic en el botón "Cargar Tema"
        $('#btnCargarTema').click(function() {
            $('#modalCargarTema').fadeIn();
        });

        // Cerrar el modal al hacer clic en la "X" o en el botón "Cancelar"
        $('.close, #btnCancelar').click(function() {
            $('#modalCargarTema').fadeOut();
        });

        // Ajustar la altura de los textareas según el contenido
        $('textarea').on('input', function() {
            this.style.height = 'auto';
            this.style.height = (this.scrollHeight) + 'px';
        });

        // Función para cargar datos de la tabla (ya proporcionada en tu código)
        function cargarDatos() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Delegación de eventos para los botones de la tabla (ya proporcionada)
                    // Código ya incluido en tu script original
                }
            });
        }
