...
<div id="modalComisionAverasistencia" class="modal-comision-a">
    <div class="modal-content-comision-a">
        ...
        <h1>Comisión A</h1>
        <input type="hidden" id="comisionId" value="18"> <!-- Aquí se almacena el ID de la comisión -->
...
<div id="modalComisionCverasistencia" class="modal-comision-c">
    <div class="modal-content-comision-a">
        ...
        <h1>Comisión C</h1>
        <input type="hidden" id="comisionIdC" value="20">
        <div class="date-picker">
...
<button id="open-attendance-button"  onclick="openAttendanceModal()">Tomar Asistencia de 1er Año</button>
...
<th rowspan="2">Apellido</th>
    ...
    WHERE ia.carreras_idCarrera = '18'";
    ...
    ?>
        ...
        <input type="hidden" name="idcarrera" value="18">
...
<tr>
    ...
    RIGHT JOIN inscripcion_asignatura ia ON a.inscripcion_asignatura_idinscripcion_asignatura = ia.idinscripcion_asignatura 
    INNER JOIN alumno a2 ON ia.alumno_legajo = a2.legajo  
    WHERE ia.carreras_idCarrera = '19'";
    $query = mysqli_query($conexion, $sql);
    while ($datos = mysqli_fetch_assoc($query)) {
        ?>
...
<tr>
    ...
    RIGHT JOIN inscripcion_asignatura ia ON a.inscripcion_asignatura_idinscripcion_asignatura = ia.idinscripcion_asignatura 
    INNER JOIN alumno a2 ON ia.alumno_legajo = a2.legajo  
    WHERE ia.carreras_idCarrera = '20'";
    $query = mysqli_query($conexion, $sql);
    while ($datos = mysqli_fetch_assoc($query)) {
        ?>
   ...
   <?php
    ...
    ?>
        ...
        <input type="hidden" name="idcarrera" value="20"> <!-- isput oculto para pasar el id de la carrera -->
        <input type="submit" name="Enviar" value="Enviar" class="btn-enviar">
            </form>
        </div>
    </div>
