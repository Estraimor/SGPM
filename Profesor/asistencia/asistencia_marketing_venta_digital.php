...
<div id="modalComisionAverasistencia" class="modal-comision-a">
    <div class="modal-content-comision-a">
        ...
        <h1>Comisión A</h1>
        <input type="hidden" id="comisionId" value="14"> <!-- Aquí se almacena el ID de la comisión -->
...
<div id="modalComisionBverasistencia" class="modal-comision-b">
    <div class="modal-content-comision-a">
        <span id="closeComisionB" class="close-comision-b" onclick="closeModalComisionBverasistencia()">&times;</span>
          <h1>Comisión B</h1>
        <input type="hidden" id="comisionIdB" value="14"> <!-- Cambiado el ID a comisionIdB -->
        <div class="date-picker">
...
<div id="modalComisionCverasistencia" class="modal-comision-c">
    <div class="modal-content-comision-a">
        ...
        <h1>Comisión C</h1>
        <input type="hidden" id="comisionIdC" value="14">
        <div class="date-picker">
...
<button id="open-attendance-button"  onclick="openAttendanceModal()">Abrir Asistencia Marketing y Venta Digital</button>
...
<tr>
    ...
    WHERE ia.carreras_idCarrera = '14'";
    ...
    ?>
        ...
        <input type="hidden" name="idcarrera" value="14">
...
<tr>
   ...
   <?php
    ...
    ?>
        ...
        <input type="hidden" name="idcarrera" value="14"> <!-- isput oculto para pasar el id de la carrera -->
        <input type="submit" name="Enviar" value="Enviar" class="btn-enviar">
            </form>
        </div>
    </div>
